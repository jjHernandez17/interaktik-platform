...
CREATE INDEX IF NOT EXISTS idx_snake_vs_snake_state_updated_at ON snake_vs_snake_state (updated_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_user_tiktok_connections_game_type ON user_tiktok_connections (user_id, game_type);
